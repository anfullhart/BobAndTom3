...
const AddBit = () => {
  ...
  useEffect(() => {
    Axios.get(`${API_URL}/api/get/celebrity`).then((res) =>
      setCelebList(res.data)
    );
    Axios.get(`${API_URL}/api/get/subject`).then((res) =>
      setSubjectList(res.data)
    );
    Axios.get(`${API_URL}/api/get/artist`).then((res) =>
      setArtistList(res.data)
    );
    Axios.get(`${API_URL}/api/get/category`).then((res) =>
      setCategoryList(res.data)
    );
    Axios.get(`${API_URL}/api/get/sport`).then((res) =>
      setSportList(res.data)
    );
    Axios.get(`${API_URL}/api/get/season`).then((res) =>
      setSeasonList(res.data)
    );
    Axios.get(`${API_URL}/api/get/album`).then((res) =>
          ...
          {hyperlinks.map((link, index) => (
            <div className="form-row" key={index}>
              ...
              <input
                ...
                value={link}
                onChange={(e) =>
                  updateHyperlink(index, e.target.value)
                }
